...
class Query(Base):
    ...
    created_at = Column(DateTime, nullable=False, default=_now)
    # check_interval: how often to run this query. Options: "1d" (default), "1w", "1mo".
    # next_check_at: when to next run this query. NULL means due immediately.
    check_interval = Column(String, nullable=False, default="1d")
